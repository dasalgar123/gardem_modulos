 ...
 * 
 * INSTRUCCIONES:
 * 1. Cambia los valores de abajo con los datos que te dé InfinityFree
...
const DB_HOST = 'sql.infinityfree.com'; // Host específico de InfinityFree
const DB_NAME = 'tu_nombre_bd_infinity'; // El nombre que elijas para tu BD
const DB_USER = 'tu_usuario_infinity';   // El usuario que te dé InfinityFree
const DB_PASS = 'tu_password_infinity';  // La contraseña que elijas

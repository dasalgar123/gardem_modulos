...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        // Obtener nombres de talla y color
        $talla_nombre = null;
        $color_nombre = null;
        ...
        if ($talla_id) {
            ...
            $result = $stmt->fetch();
            $talla_nombre = $result['nombre'] ?? null;
        }
        ...
        if ($color_id) {
            ...
            $result = $stmt->fetch();
            $color_nombre = $result['nombre'] ?? null;
        }
                                        ...
                                        <select class="form-select" id="talla_id" name="talla_id">
                                            ...
                                            <?php foreach ($tallas as $talla): ?>
                                                <option value="<?php echo $talla['id']; ?>" 
                                                        <?php echo ($salida['talla'] == $talla['nombre']) ? 'selected' : ''; ?>>
                                        ...
                                        <select class="form-select" id="color_id" name="color_id">
                                            ...
                                            <?php foreach ($colores as $color): ?>
                                                <option value="<?php echo $color['id']; ?>" 
                                                        <?php echo ($salida['color'] == $color['nombre']) ? 'selected' : ''; ?>>

            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4><i class="fas fa-tachometer-alt"></i> Panel Principal - <?php echo ucfirst($page); ?></h4>
                    </div>
                    <div class="card-body">
                        <h5>Bienvenido, <?php echo htmlspecialchars($_SESSION['usuario_nombre']); ?>!</h5>
                        <p>Has iniciado sesión como: <strong><?php echo ucfirst($_SESSION['usuario_rol']); ?></strong></p>
                        <p>Página actual: <strong><?php echo ucfirst($page); ?></strong></p>
                    </div>
                </div>
            </div>
        </div>

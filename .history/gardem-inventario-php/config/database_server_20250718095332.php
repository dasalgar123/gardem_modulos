 ...
 * 
 * INSTRUCCIONES:
 * 1. Cambia los valores de abajo con los datos que te dé tu servidor
 * 2. Renombra este archivo a database.php
 * 3. O modifica el archivo database.php original con estos valores
 */

// Configuración de la base de datos para SERVIDOR
// IMPORTANTE: Cambiar estos valores con los datos que te dé tu servidor
const DB_HOST = 'localhost'; // Normalmente es localhost
const DB_NAME = 'tu_nombre_base_datos'; // El nombre que elijas para tu BD
const DB_USER = 'tu_usuario_bd'; // El usuario que te dé tu servidor
const DB_PASS = 'tu_password_bd'; // La contraseña que te dé tu servidor

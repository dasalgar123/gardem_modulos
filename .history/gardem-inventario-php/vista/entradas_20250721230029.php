                    ...
                    <tbody>
                        ...
                        <?php else: ?>
                            <?php foreach ($entradas as $entrada): ?>
                                <tr>
                                    <td><?php echo $entrada['id'] ?? 'N/A'; ?></td>
                                    <td><?php echo htmlspecialchars($entrada['producto_nombre'] ?? 'N/A'); ?></td>
                                    <td><?php echo $entrada['cantidad'] ?? 'N/A'; ?></td>
                                    <td><?php echo htmlspecialchars($entrada['bodega_nombre'] ?? 'Sin bodega'); ?></td>
                                    <td><?php echo ucfirst($entrada['motivo'] ?? 'N/A'); ?></td>
                                    <td><?php echo htmlspecialchars($entrada['beneficiario'] ?? 'N/A'); ?></td>

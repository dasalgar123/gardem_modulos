<?php
// Obtener productos del inventario con categorías
$stmt = $pdo->query("
    SELECT p.*, c.nombre as categoria_nombre, 0 as stock_actual, 
           0 as stock_minimo,
                    ...
                    <tbody>
                        <?php foreach ($productos as $producto): ?>
                            <tr data-producto="<?php echo strtolower($producto['nombre']); ?>" 
                                ...
                                <td class="px-3">
                                    <span class="badge bg-info">Bodega niza</span>
                                </td>
                                <td class="px-3">

...
// Función para cargar tallas según el producto
function cargarTallasPorProducto() {
    ...
    if (productoId) {
        // Aquí podrías hacer una consulta AJAX para obtener las tallas específicas del producto
        // Por ahora mostramos todas las tallas

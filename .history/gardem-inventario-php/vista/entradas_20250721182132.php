...
// Obtener proveedores (asumiendo que tienes una tabla proveedores)
...
$stmt = $pdo->query("
    ...
    LEFT JOIN proveedores pr ON pe.beneficiario_id = pr.id
...
document.getElementById('beneficiario_tipo').addEventListener('change', function() {
    ...
    // Aquí se cargarían los beneficiarios según el tipo
    console.log('Tipo de beneficiario seleccionado:', tipo);
});
</script> 
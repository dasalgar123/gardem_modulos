<?php
// Obtener productos del inventario con stock real calculado
$stmt = $pdo->query("
    SELECT 
        p.*, 
        ...
        (COALESCE(entradas.total_entradas, 0) - COALESCE(salidas.total_salidas, 0)) as stock_calculado
    FROM productos p 
...
foreach ($productos as $producto) {
    // Usar stock calculado (entradas - salidas) o stock_actual como respaldo
    $stock = $producto['stock_calculado'] ?? $producto['stock_actual'] ?? 0;
                        ...
                        <?php foreach ($productos as $producto): ?>
                            ...
                            <tr data-producto="<?php echo strtolower($producto['nombre']); ?>" 
                                ...
                                <td class="px-3">
                                    ...
                                    <?php endif; ?>
                                    <br><small class="text-info">E: <?php echo $total_entradas; ?> | S: <?php echo $total_salidas; ?></small>
                                </td>
                                <td class="px-3">

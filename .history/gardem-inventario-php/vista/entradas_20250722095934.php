...
if (isset($_POST['editar_id'])) {
    ...
    try {
        $stmt = $pdo->prepare("UPDATE productos_entradas SET producto_id=?, cantidad=?, bodega_id=? WHERE id=?");
        $stmt->execute([$producto_id, $cantidad, $bodega_id, $id]);
        ...
        <div class="card-body">
            ...
            <form method="POST" action="index.php?page=entradas">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <label for="cantidad" class="form-label">Cantidad *</label>
                        <input type="number" class="form-control" id="cantidad" name="cantidad" required value="<?php echo $entrada_editar['cantidad']; ?>">
                    </div>
                    <div class="col-md-4">
                        <label for="bodega_id" class="form-label">Bodega</label>
                        <select class="form-select" id="bodega_id" name="bodega_id">

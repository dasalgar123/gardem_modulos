...
try {
    $stmt = $pdo->query("
        ...
        GROUP BY p.id, p.nombre, pe.referencia, p.tipo_producto, p.precio, c.nombre, t.nombre, pe.color_id, pe.talla_id
                        ...
                        <?php else: ?>
                            <?php foreach ($inventario as $item): ?>
                                <tr>
                                    ...
                                    <td><span class="badge bg-light text-dark"><?php echo $item['referencia'] ?? 'N/A'; ?></span></td>
                                    ...
                                    <td><span class="badge bg-warning"><?php echo $item['total_salidas']; ?></td>

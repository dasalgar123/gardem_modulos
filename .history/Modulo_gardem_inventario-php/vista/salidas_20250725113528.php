            ...
            <form method="POST" action="index.php?page=salidas">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" name="referencia" value="<?php echo htmlspecialchars($salida_editar['referencia'] ?? ''); ?>" readonly>
                    </div>
                    <div class="col-md-3">
                        ...
                        <?php else: ?>
                            <?php foreach ($salidas as $salida): ?>
                                <tr>
                                    ...
                                    <td><span class="badge bg-light text-dark"><?php echo !empty($salida['referencia']) ? $salida['referencia'] : 'N/A'; ?></span></td>
                                    <td>
                                        <?php if ($salida['color']): ?>

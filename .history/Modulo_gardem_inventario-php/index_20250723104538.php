...
// Mover la lógica de logout directamente al inicio del archivo
                ...
                <div class="col-md-3">
                    <div class="card bg-primary text-white">
                        <div class="card-body">
                            ...
                            <h3><?php echo isset($stats['productos']) ? $stats['productos'] : '0'; ?></h3>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card bg-success text-white">
                        <div class="card-body">
                            ...
                            <h3><?php echo isset($stats['categorias']) ? $stats['categorias'] : '0'; ?></h3>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card bg-warning text-white">
                        <div class="card-body">
                            ...
                            <h3><?php echo isset($stats['entradas_hoy']) ? $stats['entradas_hoy'] : '0'; ?></h3>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card bg-info text-white">
                        <div class="card-body">
                            ...
                            <h3><?php echo isset($stats['salidas_hoy']) ? $stats['salidas_hoy'] : '0'; ?></h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    <div class="card bg-danger text-white">
                        <div class="card-body">
                            <h5><i class="fas fa-exclamation-triangle"></i> Productos Agotados</h5>
                            <h3><?php echo isset($stats['agotados']) ? $stats['agotados'] : '0'; ?></h3>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="card bg-warning text-white">
                        <div class="card-body">
                            ...
                            <h3><?php echo isset($stats['stock_bajo']) ? $stats['stock_bajo'] : '0'; ?></h3>
                        </div>
                    </div>
                </div>
            </div>

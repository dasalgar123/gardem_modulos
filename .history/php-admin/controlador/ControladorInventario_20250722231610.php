        ...
        try {
            ...
            $sql = "
                ...
                LEFT JOIN productos_entradas e ON p.id = e.producto_id 
                    AND (e.color_id = p.color_id OR e.color_id IS NULL)
                    AND (e.talla_id = p.talla_id OR e.talla_id IS NULL)
                LEFT JOIN productos_salidas s ON p.id = s.producto_id 
                    AND (s.color_id = p.color_id OR s.color_id IS NULL)
                    AND (s.talla_id = p.talla_id OR s.talla_id IS NULL)

                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="salida-details">
                                        ...
                                        <?php if (!empty($salida['venta_id'])): ?>
                                        <div class="salida-venta">
                                            <i class="fas fa-shopping-cart"></i> Venta ID: <?php echo htmlspecialchars($salida['venta_id']); ?>
                                        </div>
                                        <?php endif; ?>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div class="salida-destinatario">
                                        <div><i class="fas fa-user"></i> <?php echo htmlspecialchars($salida['destinatario_tipo']); ?></div>
                                        <div><i class="fas fa-id-card"></i> ID: <?php echo htmlspecialchars($salida['destinatario_id']); ?></div>
                                        <?php if (!empty($salida['cliente_id'])): ?>
                                        <div><i class="fas fa-user-tie"></i> Cliente ID: <?php echo htmlspecialchars($salida['cliente_id']); ?></div>
                                        <?php endif; ?>
                                    </div>
                                </td>
                                <td>

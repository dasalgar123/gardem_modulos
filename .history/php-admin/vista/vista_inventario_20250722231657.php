                            ...
                            <?php else: ?>
                                ...
                                <tr class="<?php echo ControladorInventario::getStockColor($item['saldo']); ?>">
                                    ...
                                    <td class="product-type">
                                        <span class="badge badge-primary"><?php echo htmlspecialchars($item['tipo_producto']); ?></span>
                                    </td>
                                    <td class="price">
                                        <span class="badge badge-success"><?php echo ControladorInventario::formatPrice($item['precio']); ?></span>
                                    </td>
                                    <td class="color">
                                        <span class="badge badge-secondary"><?php echo htmlspecialchars($item['color'] ?? 'N/A'); ?></span>
                                    </td>
                                    <td class="size">
                                        <span class="badge badge-secondary"><?php echo htmlspecialchars($item['talla'] ?? 'N/A'); ?></span>
                                    </td>
                                    <td class="total-entradas">
                                        <span class="badge badge-info"><?php echo htmlspecialchars($item['total_entradas']); ?></span>
                                    </td>
                                    <td class="total-salidas">
                                        <span class="badge badge-warning"><?php echo htmlspecialchars($item['total_salidas']); ?></span>
                                    </td>
                                    <td class="saldo">
                                        <span class="badge badge-dark"><?php echo htmlspecialchars($item['saldo']); ?></span>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            <?php endif; ?>

                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="entrada-details">
                                        ...
                                        <?php if (!empty($entrada['color'])): ?>
                                        <div class="entrada-color">
                                            <i class="fas fa-palette"></i> Color: <?php echo htmlspecialchars($entrada['color']); ?>
                                        </div>
                                        <?php endif; ?>
                                        <?php if (!empty($entrada['talla'])): ?>
                                        <div class="entrada-size">
                                            <i class="fas fa-ruler"></i> Talla: <?php echo htmlspecialchars($entrada['talla']); ?>
                                        </div>
                                        <?php endif; ?>
                                    </div>
                                </td>

                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="qrSize">
                                <option value="96">96x96 (Pequeño)</option>
                                <option value="128" selected>128x128 (Mediano)</option>
                                <option value="200">200x200 (Grande)</option>
                            </select>
                        </div>
                    ...
                    <div class="card-body">
                        <div id="qrContainer" class="text-center">
                            <div class="text-muted">
                                ...
                                <p>Selecciona la información y genera el código QR</p>
                            </div>
                        </div>

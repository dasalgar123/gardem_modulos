...
<body class="bg-light">
        ...
        <div class="row">
            <div class="col-12">
                <h1 class="h3 mb-4">
                    ...
                    Generador de Códigos QR - Inventario
                </h1>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="qrType">
                                <option value="url">URL del Inventario</option>
    ...
    <script>
        ...
        function generateQR() {
            ...
            switch(type) {
                case 'url':
                    data = window.location.origin + '/gardem/Modulo_gardem_vendedor-php/vista/index.php?page=inventario';
                    break;
                case 'product':
                    ...
                    break;
                case 'summary':
                    data = `GARDEM - Inventario\nFecha: ${new Date().toLocaleDateString()}\nTotal Productos: ${window.productsData ? window.productsData.length : 'N/A'}\nURL: ${window.location.origin}/gardem/Modulo_gardem_vendedor-php/vista/index.php?page=inventario`;
                    break;
            }
        ...
        function generateProductQR(productId) {
            const size = document.getElementById('qrSize').value;
            const data = `Producto ID: ${productId}\nURL: ${window.location.origin}/gardem/Modulo_gardem_vendedor-php/vista/index.php?page=inventario&product=${productId}`;
            generateQRCode(data, size);
        }

                            ...
                            <div class="producto-row border rounded p-3 mb-3" data-producto-id="1">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-1">
                                        ...
                                        <input type="number" class="form-control subtotal-input" name="productos[1][subtotal]" placeholder="Total" readonly>
                                    </div>
        ...
        boton.addEventListener('click', function() {
            ...
            nuevaFila.innerHTML = `
                ...
                <div class="row">
                    ...
                    <div class="col-md-1">
                        <label class="form-label">Total</label>
                        <input type="number" class="form-control subtotal-input" name="productos[${numeroProducto}][subtotal]" placeholder="Total" readonly>
                    </div>
                    <div class="col-md-1 d-flex align-items-end">
                        <button type="button" class="btn btn-danger btn-sm remover-producto" style="margin-bottom: 0;">
                            <i class="fas fa-trash"></i>

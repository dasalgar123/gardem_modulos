...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center pt-3 mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Gestión y consulta de productos disponibles</p>
        </div>
        <div class="d-flex gap-2">
            ...
            <button class="btn btn-outline-info" onclick="printInventario()">
            ...
            <div class="card shadow-sm border-0 bg-gradient-primary text-white">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h6 class="card-title mb-0 opacity-75">Total Productos</h6>
                            <h3 class="mb-0 fw-bold"><?php echo $stats['total_productos']; ?></h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow-sm border-0 bg-gradient-success text-white">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h6 class="card-title mb-0 opacity-75">Disponible</h6>
                            <h3 class="mb-0 fw-bold"><?php echo $stats['productos_disponibles']; ?></h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow-sm border-0 bg-gradient-warning text-white">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h6 class="card-title mb-0 opacity-75">Stock Bajo</h6>
                            <h3 class="mb-0 fw-bold"><?php echo $stats['productos_stock_bajo']; ?></h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow-sm border-0 bg-gradient-danger text-white">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h6 class="card-title mb-0 opacity-75">Agotado</h6>
                            <h3 class="mb-0 fw-bold"><?php echo $stats['productos_agotados']; ?></h3>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table table-hover mb-0" id="inventarioTable">
                        ...
                        <tbody>
                            <?php foreach ($inventario as $item): ?>
                                ...
                                <tr>
                                    <td class="px-3">
                                        <span class="badge bg-secondary"><?php echo htmlspecialchars($item['referencia']); ?></span>
                                    </td>
                                    <td class="px-3">
                                        <div>
                                    ...
                                    <td class="px-3">
                                        <span class="inventario-talla-color"><?php echo htmlspecialchars($item['talla'] ?? 'N/A'); ?></span>
                                    </td>
                                    <td class="px-3">
                                        <span class="inventario-talla-color"><?php echo htmlspecialchars($item['color'] ?? 'N/A'); ?></span>
                                    </td>
                                    <td class="px-3">
                                        <span class="inventario-cantidad"><?php echo htmlspecialchars($item['stock_total']); ?></span>
                                    </td>
                                    <td class="px-3">
                                        <span class="inventario-precio"><?php echo ControladorInventario::formatPrice($item['precio']); ?></span>
                                    </td>
                                    <td class="px-3">

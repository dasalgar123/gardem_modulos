    ...
    <div class="row">
        <div class="col-12">
                ...
                <div class="container-fluid py-3">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            ...
                            <a href="../insertar_productos_prueba.php" class="btn btn-success btn-sm ms-2">
            ...
            <div class="container-fluid">
                ...
                <!-- Botón para agregar productos de prueba -->
                <?php if (empty($inventario)): ?>
                    <div class="alert alert-info alert-dismissible fade show" role="alert">
                        <i class="fas fa-info-circle me-2"></i>
                        No hay productos en el inventario. 
                        <a href="?page=inventario&action=insertar_prueba" class="btn btn-success btn-sm ms-2">
                            <i class="fas fa-plus me-1"></i> Agregar Productos de Prueba
                        </a>
                        <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                    </div>
                <?php endif; ?>
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-header bg-light d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <span class="badge bg-primary"><?php echo count($inventario); ?> productos</span>
                    ...
                    <div class="card-body py-2 bg-light border-bottom">
                        <small class="text-muted">
                            ...
                            Total productos: <?php echo $total_variantes; ?> | 
                            Con stock: <?php echo $productos_con_datos; ?> | 

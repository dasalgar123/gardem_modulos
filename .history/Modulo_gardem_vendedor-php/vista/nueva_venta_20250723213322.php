...
<body class="bg-light">
    ...
    <!-- Script para nueva venta - DESHABILITADO -->
    <script>
    // DESHABILITADO - Este archivo no se debe usar
    console.log('nueva_venta.php está deshabilitado');
    ...
    // Función para crear nueva fila de producto - DESHABILITADA
    function crearFilaProducto(numero) {
        console.log('nueva_venta.php está deshabilitado - no se pueden crear filas de producto');
        return null; // No crear nada
    }
    ...
    // Función para agregar producto - DESHABILITADA
    function agregarProducto() {
        console.log('nueva_venta.php está deshabilitado - no se puede agregar productos');
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Event listener para agregar producto - DESHABILITADO
        const btnAgregar = document.getElementById('agregarProductoNuevaVenta');
        if (btnAgregar) {
            console.log('nueva_venta.php está deshabilitado - no se agregan event listeners');
            // No agregar event listeners
        }

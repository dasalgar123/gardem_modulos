...
<div class="container-fluid">
    ...
    <?php if (isset($_GET['success']) && $_GET['success'] == 1): ?>
        <div class="alert alert-success"><strong>¡Éxito!</strong> La venta con factura <?php echo htmlspecialchars($_GET['factura'] ?? ''); ?> ha sido registrada correctamente.
        </div>
    <?php endif; ?>
                                    ...
                                    <div class="col-md-4">
                                        <select class="form-select producto-select" name="productos[1][producto_id]" required>
                                            ...
                                            <?php foreach ($productos as $producto): ?>
                                                <option value="<?php echo $producto['id']; ?>" data-tipo="<?php echo htmlspecialchars($producto['tipo_producto']); ?>" data-precio="<?php echo $producto['precio']; ?>"><?php echo htmlspecialchars($producto['nombre']); ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-1">
                                        <select class="form-select talla-select" name="productos[1][talla_id]" required>
                                            ...
                                            <?php foreach ($tallas as $talla): ?>
                                                <option value="<?php echo $talla['id']; ?>" data-categoria="<?php echo $talla['categoria']; ?>"><?php echo htmlspecialchars($talla['nombre']); ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                            ...
                            <div class="card border-info">
                                ...
                                <div class="card-body">
                                    <div class="row align-items-end">
                                        ...
                                        <div class="col"><button type="submit" class="btn btn-primary w-100"><i class="fas fa-save"></i></button></div>
                                    </div>
                                </div>
                            </div>
                        </div>

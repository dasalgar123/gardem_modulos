                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-1">
                                     ...
                                     <div class="col-md-2">
                                         ...
                                         <input type="number" class="form-control precio-input" name="productos[1][precio]" placeholder="Precio Unitario" step="0.01" readonly>
                                     </div>
                                     <div class="col-md-2">
                                         <label class="form-label">Subtotal</label>
                                         <input type="number" class="form-control subtotal-input" name="productos[1][subtotal]" placeholder="Subtotal" step="0.01" readonly>
                                     </div>
                                     <div class="col-md-1 d-flex align-items-end">
                                         <button type="button" class="btn btn-danger btn-sm remover-producto" style="margin-bottom: 0;">
    ...
    let ventasModule = {
            ...
            fila.innerHTML = `
                ...
                <div class="row">
                    ...
                    <div class="col-md-1">
                     ...
                     <div class="col-md-2">
                         <label class="form-label">Precio Unitario</label>
                         <input type="number" class="form-control precio-input" name="productos[${numeroProducto}][precio]" placeholder="Precio Unitario" step="0.01" readonly>
                     </div>
                     <div class="col-md-2">
                         <label class="form-label">Subtotal</label>
                         <input type="number" class="form-control subtotal-input" name="productos[${numeroProducto}][subtotal]" placeholder="Subtotal" step="0.01" readonly>
                     </div>
                    <div class="col-md-1 d-flex align-items-end">
                        <button type="button" class="btn btn-danger btn-sm remover-producto" style="margin-bottom: 0;" title="Eliminar producto">
                            <i class="fas fa-trash"></i>
                        </button>
                    </div>
                </div>
        ...
        renumerarProductos: function() {
            ...
            productos.forEach((producto, index) => {
                const numero = producto.querySelector('h6');
                if (numero) {
        ...
        obtenerOpcionesTallas: function() {
            ...
            return '';
             ...
             productos.forEach(producto => {
                 const precio = producto.querySelector('.precio-input');
                 const cantidad = producto.querySelector('.cantidad-input');
                 
                 if (precio && precio.value && cantidad && cantidad.value) {
                     const precioValor = parseFloat(precio.value) || 0;
                     const cantidadValor = parseFloat(cantidad.value) || 0;
                     subtotal += precioValor * cantidadValor;
                 }
             });

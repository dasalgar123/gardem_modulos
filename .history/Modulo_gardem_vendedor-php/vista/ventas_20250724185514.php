...
<section class="container-fluid">
    ...
    <div class="card">
        <div class="card-header"><h5 class="mb-0"><i class="fas fa-list me-2"></i>Historial de Ventas (<?php echo $total_ventas; ?> registros)</h5></div>
        <div class="card-body">
            <?php if (empty($ventas)): ?>
...
<!-- Modal Nueva Venta -->
<section class="modal fade" id="nuevaVentaModal" tabindex="-1" aria-labelledby="nuevaVentaModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <section class="row mb-4">
                        <div class="col-md-6">
                            <div class="card border-primary">
                                ...
                                <div class="card-body">
                                    <h5 class="text-primary mb-1">GARDEL</h5>
                    ...
                    <section class="mb-4">
                        ...
                        <section id="productosContainer">
                            <!-- Producto 1 -->
                            <section class="producto-row border rounded p-2 mb-2" data-producto-id="1">
                                <div class="row g-2">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-1"><input type="number" class="form-control precio-input" name="productos[1][precio]" placeholder="Precio" step="0.01" readonly></div>
                                    <div class="col-md-2"><input type="number" class="form-control subtotal-input" name="productos[1][subtotal]" placeholder="Total" step="0.01" readonly></div>
                                ...
                                <div class="card border-info">
                                 ...
                                 <div class="card-body">
                                    <div class="row align-items-end">
                                        ...
                                        <div class="col"><button type="button" class="btn btn-secondary w-100" id="btnCancelar"><i class="fas fa-times"></i></button></div>
                                        <div class="col"><button type="submit" class="btn btn-primary w-100"><i class="fas fa-save"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </div>

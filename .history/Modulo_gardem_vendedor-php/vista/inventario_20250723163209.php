                        ...
                        <tbody>
                            <?php foreach ($inventario as $item): ?>
                                ...
                                <tr>
                                    ...
                                    <td class="px-3">
                                        <span class="badge bg-light text-dark"><?php echo htmlspecialchars($item['talla'] ?? 'N/A'); ?></span>
                                    </td>
                                    <td class="px-3">
                                        <span class="badge bg-light text-dark"><?php echo htmlspecialchars($item['color'] ?? 'N/A'); ?></span>
                                    </td>
                                    <td class="px-3">
                                        <span class="fw-bold"><?php echo htmlspecialchars($item['stock_total']); ?></span>
                                    </td>
                                    <td class="px-3">

...
function initializeVentas() {
    ...
    if (btnAgregarProducto) {
        console.log('Event listener DESHABILITADO para el botón de agregar producto');
        // No agregar event listener
    } else {
 ...
 */
let ventasModule = {
    isAddingProduct: false, // Flag para evitar múltiples agregaciones
    ...
    agregarProducto: function(e) {
        ...
        // Evitar agregar múltiples productos simultáneamente
        if (this.isAddingProduct) return;
        this.isAddingProduct = true;
        
        console.log('Agregando producto...'); // Debug
